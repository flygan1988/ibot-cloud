...
import com.taiping.ibot.server.knowledge.properties.IBotSwaggerProperties;
...
public class IBotWebConfigure {
    ...
    public Docket swaggerApi() {
        IBotSwaggerProperties swagger = properties.getSwagger();
    ...
    private ApiInfo apiInfo(IBotSwaggerProperties  swagger) {
        return new ApiInfo(
                swagger.getTitle(),
    ...
    private SecurityScheme securityScheme(IBotSwaggerProperties swagger) {
    ...
    private SecurityContext securityContext(IBotSwaggerProperties swagger) {
    ...
    private AuthorizationScope[] scopes(IBotSwaggerProperties swagger) {
