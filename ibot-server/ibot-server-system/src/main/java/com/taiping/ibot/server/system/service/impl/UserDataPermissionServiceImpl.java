...
import com.taiping.ibot.server.system.mapper.UserDataPermissionMapper;
...
public class UserDataPermissionServiceImpl extends ServiceImpl<UserDataPermissionMapper, UserDataPermission> implements IUserDataPermissionService {
    ...
    public String findByUserId(String userId) {
        ...
        return this.baseMapper.selectList(wrapper).stream().map(permission -> String.valueOf(permission.getDeptId())).collect(Collectors.joining(","));
    }
}